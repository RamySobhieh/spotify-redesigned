...
function Track({ track, chooseTrack }) {
  ...
  return (
    <div
      className="flex items-center md:justify-between space-x-4 hover:bg-white/10 py-2 px-4 rounded-lg group transition ease-out cursor-pointer"
      onClick={handlePlay}
    >
      <div className="flex items-center">
        ...
        />
        <div>
          <h4 className="text-white text-sm font-semibold truncate w-[180px] md:w-[450px]">
            {track.title}
          </h4>
      ...
      <div className="hidden md:ml-auto md:flex items-center space-x-2.5">
